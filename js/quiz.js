...
function loadQuestionModal() {
    ...
    if (window.QuestionModal) {
        QuestionModal.init({
            ...
            triggerElement: ".article-page",
            theme: questionModalTheme
        });
        console.log("trigger:", document.querySelector(".article-page"));
console.log("questions:", document.querySelectorAll(".question").length);
        QuestionModal.showButton(0);
        return;
    }
    ...
    css.rel = "stylesheet";
    css.href = "../question-modal/question-modal.css";
    document.head.appendChild(css);

    // Theme script
    const themeScript = document.createElement("script");
    themeScript.src = "../question-modal/question-modal-theme.js";

    themeScript.onload = () => {

        // QuestionModal script
        const modalScript = document.createElement("script");
        modalScript.src = "../question-modal/question-modal.js";
        ...
        modalScript.onerror = () => {
            console.error(
                "QuestionModal: Failed to load question-modal.js"
            );
        };
    ...
    themeScript.onerror = () => {
        console.error(
            "QuestionModal: Failed to load question-modal-theme.js"
        );
    };
